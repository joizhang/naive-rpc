...
public class DemoServiceApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (RpcAccessPoint rpcAccessPoint =
            ...
            DemoServiceApp.registerService(
                    rpcAccessPoint, nameService, socketAddress, HelloService.class, new HelloServiceImpl());
            // register UserService
            DemoServiceApp.registerService(
                    rpcAccessPoint, nameService, socketAddress, UserService.class, new UserServiceImpl());
