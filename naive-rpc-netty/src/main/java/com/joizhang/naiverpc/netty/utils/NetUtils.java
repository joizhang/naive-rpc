...
public class NetUtils {
    ...
    private static final String DUBBO_NETWORK_IGNORED_INTERFACE = "dubbo.network.interface.ignored";
    ...
    public static boolean isAnyHost(String host) {
        return ANY_HOST_VALUE.equals(host);
    }
